...
public class ProductoResourceIT {
    ...
    private static final Float DEFAULT_CANTIDA = 1F;
    private static final Float UPDATED_CANTIDA = 2F;
    ...
    public void createProducto() throws Exception {
        ...
        assertThat(testProducto.getCantida()).isEqualTo(DEFAULT_CANTIDA);
    }
    ...
    public void getAllProductos() throws Exception {
        ...
        restProductoMockMvc.perform(get("/api/productos?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].cantida").value(hasItem(DEFAULT_CANTIDA.doubleValue())));
    }
    ...
    public void getProducto() throws Exception {
        ...
        restProductoMockMvc.perform(get("/api/productos/{id}", producto.getId()))
            ...
            .andExpect(jsonPath("$.cantida").value(DEFAULT_CANTIDA.doubleValue()));
    }
    ...
    public void updateProducto() throws Exception {
        ...
        assertThat(testProducto.getCantida()).isEqualTo(UPDATED_CANTIDA);
    }
